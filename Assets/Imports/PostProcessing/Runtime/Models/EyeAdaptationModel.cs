...
namespace UnityEngine.PostProcessing
{
    ...
    public class EyeAdaptationModel : PostProcessingModel
    {
        ...
        public struct Settings
        {
            ...
            [PostProcessingMin(0f), Tooltip("Exposure bias. Use this to offset the global exposure of the scene.")]
            ...
            [PostProcessingMin(0f), Tooltip("Adaptation speed from a dark to a light environment.")]
            public float speedUp;

            [PostProcessingMin(0f), Tooltip("Adaptation speed from a light to a dark environment.")]
